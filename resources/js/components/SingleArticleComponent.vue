            ...
            <div class="col-md-8 col-md-offset-2 col-xs-12">
                <div class="mainheading">
                    ...
                    <div class="row post-top-meta">
                        <div class="col-md-2">
                            <a v-bind:href="'/users/'+article.author"><img class="author-thumb" v-bind:src="appBaseUrl+'/assets/img/avatar.png'" alt="Sal"></a>
                        </div>
                        <div class="col-md-10">
                            <a class="link-dark">{{article.name}}</a><a href="#/follow" class="btn follow">Follow</a>
                            <span class="author-description"></span>
                            <span class="post-date"></span><span class="dot"></span><span class="post-read">6 min read</span>
                        </div>
                    </div>
                    <!-- End Top Menta -->
                ...
                <img class="featured-image img-fluid" v-bind:src="( (JSON.parse(article.thumbnail_path)[0].includes('images'))? appBaseUrl+'/'+JSON.parse(article.thumbnail_path)[0]: JSON.parse(article.thumbnail_path)[0])" alt="">
                <!-- End Featured Image -->
...
export default {
    ...
    mounted() {
        axios.get(this.baseUrl+'/api/v1/articles/'+this.postId)
        .then((response) => {
